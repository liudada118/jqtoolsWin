        ...
        <>
            ...
            <div className="colInfo fs14">
                ...
                <div className='changeColInfo'>
                    ...
                    }} className='iconfont cursor' style={{ color: changeColInfo ? '#0072EF' : '#B4C0CA' }}>&#xe623;</i></div>
            </div>
            ...
            <div className='colTimeAndHistory'>
                ...
                <div className='historyButton cursor fs14' onClick={() => {
                    getColHistory()
                }}>
                    <i className='iconfont'>&#xe624;</i>{t('history')}
                </div>
